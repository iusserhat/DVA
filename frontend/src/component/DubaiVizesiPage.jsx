    ...
    <div style={{
        ...
        <div style={{
          ...
          <nav style={{
            ...
            <div style={{
              ...
              <Link to="/dubai-vizesi" style={{ textDecoration: 'none', color: '#D71923', fontWeight: 'bold' }}>Dubai Vizesi</Link>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{ color: '#D71923', fontSize: '24px', marginBottom: '20px' }}>Dubai Vizesi</h1>
          
          <p style={{ fontSize: '14px', lineHeight: '1.6', color: '#333', marginBottom: '15px' }}>
            Dubai vizesi hakkında bilgileri burada görebilirsiniz. Dubai vizesi, Birleşik Arap Emirlikleri'nin Dubai emirliğine seyahat etmek için gerekli olan resmi bir belgedir.
          </p>
          
          <div style={{ marginTop: '30px', display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
            <Link to="/yeni-basvuru" style={{
              padding: '12px 20px',
              backgroundColor: '#D71923',
              color: 'white',
              textDecoration: 'none',
...
export default DubaiVizesiPage; 